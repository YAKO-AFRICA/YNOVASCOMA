                    ...
                    <div class="card-body">
                        <form id="loanSimulatorForm" class="row g-3 needs-validation" novalidate>
                            ...
                            <div class="col-12 d-flex justify-content-between align-items-center">
                                <button type="submit" class="btn btn-primary text-uppercase btn-lg">Évaluer la Prime</button>

                                {{-- @can('Initier un pret') --}}
                                    <button class="btn" id="btnSouscrition" disabled>
                                        <a href="{{ route('epret.create')}}" class="btn btn-outline-primary text-uppercase border-0" >Démarrer une Souscription</a>
                                    </button>
                                {{-- @endcan --}}
                            </div>
                        </form>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="result-container">
                            ...
                            <div class="card mb-3" id="primeObsequeCard">
                                <div class="card-body" style="background-color: #fff1eb">
                                    <h5 class="card-title">Prime Emprunteur :</h5>
