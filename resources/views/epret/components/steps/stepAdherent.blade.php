...
<div class="row g-3 mb-3">
    <div class="col-12 col-lg-6">
        ...
        <input type="date" name="datenaissance" class="form-control" id="Date_naissance" autocomplete="on"  value="{{ $valueDateNaissance }}" required readonly>
...
<div class="row g-3 mb-3">
    <div class="col-12 col-lg-4">
        ...
        <div class="input-group mb-3">
            <input type="text" name="mobile" class="form-control" autocomplete="on" required maxlength="10" required>
        </div>
...
<fieldset class="border p-3">
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="input-group mb-3">
                <input type="text" name="contactpersonneressource" class="form-control" aria-label="Text input with select" maxlength="10" required>
            </div>
        </div>
    </div>
