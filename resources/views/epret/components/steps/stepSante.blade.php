<fieldset id="medicalHistoryForm">
...
<div class="row g-3 mb-4">
    <div class="col-md-6">
        ...
        <div class="input-group">
            <input type="number" class="form-control" id="taille" placeholder="0" name="taille" value="{{ $simulationData['taille'] ?? '-' }}" readonly required>
    ...
    <div class="col-md-6">
        ...
        <div class="input-group">
            <input type="number" class="form-control" name="poids" id="poids"  value="{{ $simulationData['poids'] ?? '-' }}" readonly required>
