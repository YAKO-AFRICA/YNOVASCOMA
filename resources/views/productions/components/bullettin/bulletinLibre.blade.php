...
<body>
    ...
    <div class="a4-container ">
        ...
        <div style="width: 100%;">
            <div class="col" style="width: 50%; float: left">Agence : ......................</div>
            <div class="col" style="width: 50%; float: right; text-align: right; margin-right: 0px">Bulletin N° : ...............</div>
        </div>
                ...
                <div class="content1" style="padding: 5px; margin-top: 5px">
                    <div class="identite" style="width: 100%">
                        <div class="civilite" style="float: left; width: 50%">
                            <label for="civilite"><strong>Genre :</strong> ..................</label>
                        </div>
                    ...
                    <p class="identite" style="margin-top: 5px;">
                        <div class="bithday" style="float: left; width: 50%;">
                            <label for="bithday"><strong>Date de naissance :</strong>............................</label>
                        </div>

                        <div class="lieunaissance" style="float: right; width: 50%;">
                            <label for="lieunaissance"><strong>lieu de naissance :</strong> ..................................</label>
                        </div>
                    </p>

                    <p class="identite" style="margin-top: 5px">
                        <div class="domicile" style="float: left ;width: 50%">
                            <label for="domicile"><strong>Domicile :</strong> ................................</label>
                        </div>
                        <div class="postal" style="float: right; width: 50%">
                            <div class="postal">
                                <label for="postal"><strong>Email :</strong> .................................</label>
                            </div>
                        </div>
                    </p>
                    <p class="identite" style="margin-top: 5px">
                        ...
                        <div class="employeur" style="float: right; width: 50%">
                            <div class="employeur">
                                <label for="employeur"><strong>Employeur :</strong> <span>............................</span></label>
                            </div>
                        </div>
                    </p>
                    <p class="identite" style="margin-top: 5px">
                        <div class="numeropiece" style="float: left ;width: 50%">
                            <label for="numeropiece"><strong>CNI/Passport/Attestation d'identité :</strong> ..................................</label>
                        </div>
                        <div class="telephone" style="float: right; width: 50%">
                            <div class="telephone">
                                <label for="telephone"><strong>Téléphone / Cell :</strong> <span>.......................................</span></label>
                            </div>
                        </div>
                    </p>
                </div>
        ...
        <section>
            <fieldset class="" style="border: 1px solid #ccc; margin-top: 15px">
                <legend class="float-none w-auto" style="float: none; width: auto; border: 1px solid #ccc;">
                    <small style=" padding: 2px">INFORMATION DE L'ASSURE</small>
                </legend>
        ...
        <fieldset class="" style="border: 1px solid #ccc; padding: 1rem; margin-top: 20px">
            ...
            <div class="prime " style="margin-top: 10px">
                <div>
                    <strong class="underlin">
                       Fraies d'adhesion : <span >..........................</span>
                    </strong>
                </div>
                <div style="margin-left: 300px; margin-top: -28px">
                    Option de garanties : <span style="margin-left: 40px"><span>..................................</span></span>
                </div>
            ...
            <div style="margin-top: 15px">
                ...
                ........................... sur le compte d'épargne du client à raison de  
                <span class="underline">.............................Fcfa par .....................</span>
            </div>
