            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    <div class="col-12 d-flex justify-content-between ">
                        <button onclick="event.preventDefault(); stepper1.previous()" class="btn btn-outline-secondary px-4 btn-previous-form"><i class='bx bx-left-arrow-alt me-2'></i>Rettour</button>
