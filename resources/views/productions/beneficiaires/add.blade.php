                ...
                <form id="beneficiaryForm">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <select id="lienParenteBenef" class="form-select" name="lienParenteBenef">
                                ...
                                <option value="Conjoint" class="form-control">Conjoint</option>
                                <option value="Enfant" class="form-control">Enfant</option>
                                <option value="Autre" class="form-control">Autre</option>
                            </select>
                        </div>
                    </div>
                    ...
                    {{-- <div class="row g-3 mb-3 d-none">
                        <div class="col-12">
                            ...
                            <input type="number" id="partBenef" class="form-control " placeholder="Part du bénéficiaire" disabled>
                        </div>
                    </div> --}}
