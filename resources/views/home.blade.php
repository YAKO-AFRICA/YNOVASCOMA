            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        ...
                        <h4 class="my-1 text-success">{{ count($userData['myAllContratTransmis']) }}</h4>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        ...
                        <h4 class="my-1 text-warning">{{ count($userData['myAllContratMigrer']) }}</h4>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center ms-auto font-13 gap-2 mb-3">
                    <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1"
                            style="color: #14abef"></i>Transmise</span>
                    <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1"
                            style="color: #ffc107"></i>Acceptée</span>
                </div>
