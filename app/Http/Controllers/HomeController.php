...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        //user connect data
            ...
            $tauxAcceptation = ($contratsAnnuel->count() > 0) ? ($totalAccepter / $contratsAnnuel->count()) * 100 : 0;
            ...
            $allContratsDistinct = Contrat::where('saisiepar', $user->idmembre)->select('libelleproduit', DB::raw('COUNT(*) as nombre'), DB::raw('SUM(prime) as total_prime'))
