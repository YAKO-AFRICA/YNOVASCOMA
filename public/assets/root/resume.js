 ...
 document.addEventListener('DOMContentLoaded', () => {
  ...
  modePaiementRadios.forEach(radio => {
    ...
    primeInput.addEventListener('input', () => {
        displayPrimePrincipale.textContent = primeInput.valueAsNumber.toLocaleString('fr-FR', { minimumFractionDigits: 2 }) || 'Null';
    });
    ...
    fraisAdhesionInput.addEventListener('input', () => {
        ...
        displayFraisAdhesion.textContent = fraisAdhesionInput.valueAsNumber.toLocaleString('fr-FR', { minimumFractionDigits: 2 }) || 'Null';
    });
